import HautevilleHouse.EnvironmentalWaterTreatmentCanonicalLaneLean.ReviewerBridge
...
def sourceTheoremStatement : TheoremStatement := {
  ...
  constrainedStatement := "Environmental water treatment theorem certified through baseline gates, source constants, reviewer bridge, manifest hashes, and outside-constant dependency count",
